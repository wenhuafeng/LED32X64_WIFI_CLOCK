...
#run function
openocd -f user/openocd/stlink.cfg -f user/openocd/stm32f1x.cfg -c init -c halt -c "program MDK-ARM/CLOCK_STM32F103C8T6_WIFI/CLOCK_STM32F103C8T6_WIFI.bin 0x8000000" -c reset -c shutdown
